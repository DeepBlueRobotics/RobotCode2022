...
public class ShootMove extends CommandBase {
  ...
  @Override
  public void execute() {// Orientation of dt is taken over to face a certain direction
  ...
  {
    // the easiest way to ensure the solution is non-degenerate: to seed newton's method with the direction to the goal
